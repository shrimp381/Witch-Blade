...
export const TECHNIQUES = [
  // ── Core ─────────────────────────────────────────────
  { id: "phantom-step", name: "Phantom Step", group: "core", tier: "standard", action: "bonus", req: 1,
    fp: [{ d: 1 }],
  ...
  { id: "reset-pulse", name: "Reset Pulse", group: "core", tier: "standard", action: "action", req: 2,
  ...
  { id: "bone-lock-grasp", name: "Bone-Lock Grasp", group: "core", tier: "standard", action: "reaction", req: 3,
  ...
  { id: "carve-the-weak", name: "Carve the Weak", group: "core", tier: "standard", action: "action", req: 3,
    fp: [{ d: 1 }],
  ...
  { id: "blood-slick-advance", name: "Blood-Slick Advance", group: "core", tier: "standard", action: "reaction", req: 4,
    fp: [{ d: 1 }],
  ...
  { id: "reapers-carve", name: "Reaper's Carve", group: "core", tier: "standard", action: "action", req: 5,
  ...
  // ── Seeker ───────────────────────────────────────────
  { id: "ghoststep-assault", name: "Ghoststep Assault", group: "seeker", tier: "standard", action: "bonus", req: 1,
    fp: [{ d: 1 }],
    text: "Teleport up to 10 ft before a melee weapon attack. That attack has advantage." },
  { id: "lunging-precision", name: "Lunging Precision", group: "seeker", tier: "standard", action: "action", req: 1,
    fp: [{ d: 1 }],
  ...
  { id: "pinpoint-hemorrhage", name: "Pinpoint Hemorrhage", group: "seeker", tier: "standard", action: "bonus", req: 2,
    fp: [{ d: 1 }],
  ...
  { id: "veil-of-control", name: "Veil of Control", group: "seeker", tier: "standard", action: "bonus", req: 2,
  ...
  { id: "nerve-sever", name: "Nerve Sever", group: "seeker", tier: "standard", action: "bonus", req: 3,
  ...
  { id: "shadow-severance", name: "Shadow Severance", group: "seeker", tier: "standard", action: "action", req: 4,
  ...
  // ── Executioner ─────────────────────────────────────
  { id: "guttural-roar", name: "Guttural Roar", group: "executioner", tier: "standard", action: "free", req: 1,
    fp: [{ d: 1 }], dc: "8 + Prof + STR",
    text: "Enemies within 5 ft must make a Wisdom save (DC 8 + Prof + STR) or lose reactions until their next turn." },
  { id: "flesh-rend", name: "Flesh Rend", group: "executioner", tier: "standard", action: "bonus", req: 2,
    fp: [{ d: 1 }],
    text: "Until the end of your turn, your melee attacks deal +1d6 damage and cause targets to bleed (1d4 per round)." },
  { id: "chain-cleaver", name: "Chain Cleaver", group: "executioner", tier: "standard", action: "action", req: 3,
    fp: [{ d: 1 }],
    text: "Make a sweeping melee attack against up to 3 adjacent creatures (roll for each hit)." },
  { id: "shatter-the-pulse", name: "Shatter the Pulse", group: "executioner", tier: "standard", action: "bonus", req: 4,
  ...
  { id: "sever-the-line", name: "Sever the Line", group: "executioner", tier: "standard", action: "action", req: 4,
    fp: [{ d: 2 }], dc: "8 + STR",
  ...
  { id: "final-impact", name: "Final Impact", group: "executioner", tier: "standard", action: "action", req: 5,
    fp: [{ d: 3 }],
    text: "Melee attack with +5 to hit. On hit, deal +6d10 damage and knock the target prone." },

  // ── Sentinel ────────────────────────────────────────
  { id: "iron-grasp", name: "Iron-Grasp", group: "sentinel", tier: "standard", action: "reaction", req: 1,
    fp: [{ d: 1 }],
  ...
  { id: "aegis-burst", name: "Aegis Burst", group: "sentinel", tier: "standard", action: "bonus", req: 2,
    fp: [{ d: 1 }],
    text: "Pulse of force. Creatures within 10 ft must make a Strength save or be pushed 10 ft and knocked prone." },
  { id: "counterhold", name: "Counterhold", group: "sentinel", tier: "standard", action: "reaction", req: 2,
    fp: [{ d: 1 }],
  ...
  { id: "blood-fused-guard", name: "Blood-Fused Guard", group: "sentinel", tier: "standard", action: "bonus", req: 3,
    fp: [{ d: 1 }],
  ...
  { id: "bastion-rhythm", name: "Bastion Rhythm", group: "sentinel", tier: "standard", action: "bonus", req: 3,
  ...
  { id: "fortress-breaker", name: "Fortress Breaker", group: "sentinel", tier: "standard", action: "action", req: 5,
    fp: [{ d: 3 }],
    text: "Melee attack: double weapon damage + 4d10 force. Con save: fail = stunned and prone, success = just prone." },

  // ── Veil-Splitter ───────────────────────────────────
  { id: "rift-step", name: "Rift Step", group: "veil-splitter", tier: "standard", action: "bonus", req: 1,
    fp: [{ d: 1 }],
    text: "Teleport 15 ft. Gain resistance to force and psychic damage until the start of your next turn." },
  { id: "veinlash-channel", name: "Veinlash Channel", group: "veil-splitter", tier: "standard", action: "bonus", req: 2,
  ...
  { id: "feedback-collapse", name: "Feedback Collapse", group: "veil-splitter", tier: "standard", action: "bonus", req: 3,
  ...
  { id: "arcane-mutation-spike", name: "Arcane Mutation Spike", group: "veil-splitter", tier: "standard", action: "bonus", req: 4,
  ...
  { id: "veil-tearing-ritual", name: "Veil-Tearing Ritual", group: "veil-splitter", tier: "standard", action: "action", req: 4,
    fp: [{ d: 2 }],
  ...
  { id: "soulburn-arc", name: "Soulburn Arc", group: "veil-splitter", tier: "standard", action: "action", req: 5,
  ...
  // ── Advanced (level 11+) ────────────────────────────
  { id: "apex-carve", name: "Apex Carve", group: "core", tier: "advanced", action: "action", actionAssumed: true, req: 7,
  ...
  { id: "controlled-collapse", name: "Controlled Collapse", group: "core", tier: "advanced", action: "bonus", req: 9,
  ...
  { id: "bloodline-lure", name: "Bloodline Lure", group: "seeker", tier: "advanced", action: "action", actionAssumed: true, req: 6,
    fp: [{ d: 2 }],
  ...
  { id: "ghost-chain-assault", name: "Ghost Chain Assault", group: "seeker", tier: "advanced", action: "action", actionAssumed: true, req: 7,
  ...
  { id: "carnage-apex", name: "Carnage Apex", group: "executioner", tier: "advanced", action: "action", actionAssumed: true, req: 7,
    fp: [{ d: 3 }],
  ...
  { id: "feral-core-release", name: "Feral Core Release", group: "executioner", tier: "advanced", action: "bonus", req: 10,
  ...
  { id: "immovable-verdict", name: "Immovable Verdict", group: "sentinel", tier: "advanced", action: "action", actionAssumed: true, req: 7,
    fp: [{ d: 2 }], dc: "8 + Prof + STR",
  ...
  { id: "bastion-unleashed", name: "Bastion Unleashed", group: "sentinel", tier: "advanced", action: "bonus", req: 10,
  ...
  { id: "splinter-reality", name: "Splinter Reality", group: "veil-splitter", tier: "advanced", action: "action", actionAssumed: true, req: 7,
  ...
  { id: "arc-symbiotic-surge", name: "Arc-Symbiotic Surge", group: "veil-splitter", tier: "advanced", action: "action", actionAssumed: true, req: 10,
...
export const INSTABILITY = [
  ...
  { roll: 10, fp: 2, name: "Shattered Restraint", text: "Gain 2 FP and roll on the Feral Mutation table. May reroll this once per Blood Surge; if so, take 4d6 psychic damage. In Feral State: increase rounds by 1 instead of gaining 2 FP, roll on the Feral Mutation table, and you cannot reroll." }
];
